...
if ($_POST['act']=="save"){
			...
			'receiver_mobile'             =>  trim($_POST['Receiver_mobile']),//trim($_POST['Receiver_mobile']),
			'receiver_tele'             => trim($_POST['Receiver_tele']),//trim($_POST['Receiver_tele']),
        ...
        <tr>
          ...
          <td><div align="left">"<?php echo $Order_Pack[Order_Txt_Title];?>"</div><!--訂單操作方式-->
            <div id="tip01tips" class="tips_note" align="left">
              ...
              <?php echo $Order_Pack[Order_Txt_Content_III]?><br>
                  ...
                  <TR>
                    <TD bgColor=#ffffff>
					 ...
					 $Order_serial = $Rs['order_serial'];
						...
						$Receiver_tele    = trim($Rs['receiver_tele']);
						$Receiver_mobile  = trim($Rs['receiver_mobile']);//$Rs['receiver_mobile'];
            ...
            <td>
              <table width="100%" border="0" align="left" cellpadding="4" cellspacing="0" bgcolor="#F7F7F7"   class="allborder">
                ...
                <tr>
                  ...
                  <td nowrap><?php echo ($discount_totalPrices)?></td>
                  </tr>
                <tr>
                  <td align="right" valign="top" nowrap class="p9orange">紅利折抵點數：</td>
                  <td nowrap><?php echo $bonuspoint;?></td>
                  <td align="right" valign="top" nowrap class="p9orange">消費總金額：</td>
                ...
                <tr>
                  ...
                  <td nowrap="nowrap"><?php echo $totalbonuspoint;?></td>
                ...
                <tr>
                  <td align="right" valign="top" nowrap class="p9orange">物流號碼：</td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="4"   class="allborder" bgcolor="#F7F7F7">
                ...
                <tr>
                  ...
                  <td width="27%" align="left" nowrap>
                    ...
                    <span class="STYLE2"> /</span>                    <?php echo MD5Crypt::Decrypt ( trim($Result_user['other_tel']), $INFO['tcrypt'])//$Result_user['other_tel']?></td>
