...
function select_color(type)
{
	...
	str=window.showModalDialog("color_select.htm","","dialogWidth:28;dialogHeight:20");
	if (!str) return false;
	arr_str=str.split("||");
    ...
    <TD vAlign=top width="100%" height=319>
      <TABLE class=p9black cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR>
          ...
          <TD align=right width="50%"><?php if ($Ie_Type != "mozilla") { ?>
            <table cellspacing="0" cellpadding="0" border="0" id="showsave">
              <tbody>
                <tr>
                    ...
                    <tbody>
                      <tr>
                        <td align="middle" width="79"><!--BUTTON_BEGIN-->
                          ...
                          link="javascript:checkform();">
                            <tbody>
                              <tr>
                                <td valign="bottom" nowrap="nowrap"><img src="images/<?php echo $INFO[IS]?>/fb-save.gif"  border="0" />&nbsp;<?php echo $Basic_Command['Save'];//保存?>&nbsp; </td>
                              </tr>
                            </tbody>
                          </table>
                          <!--BUTTON_END--></td>
                      ...
                      <tr>
                        <td align="middle" width="79"><!--BUTTON_BEGIN-->
                          <table>
                            <tbody>
                              <tr>
                                <td valign="bottom" nowrap="nowrap"><a href="javascript:checkform();"><img src="images/<?php echo $INFO[IS]?>/fb-save.gif"  border="0" />&nbsp;<?php echo $Basic_Command['Save'];//保存?></a>&nbsp; </td>
                              </tr>
                            </tbody>
                          </table>
                          <!--BUTTON_END--></td>
  ...
  <INPUT type=hidden   name='middleimg' value="<?php echo $Mid_img?>">
                ...
                <TABLE class=allborder cellSpacing=0 cellPadding=2
                  width="100%" bgColor=#f7f7f7 border=0 id="showtable_base">
                    ...
                    <TR>
                      <TD noWrap align=right><?php echo $Admin_Product[PrductClassName];//商品類別名稱?>：</TD>
                   ...
                   <TR>
                      ...
                      <TD colSpan=2><?php echo  $DisplayProviderState =  intval($_SESSION['LOGINADMIN_TYPE'])==2 ? $Provider_name  : $FUNCTIONS->select_type("select provider_name,provider_id from `{$INFO[DBPrefix]}provider` order by provider_idate  ","provider_id","provider_id","provider_name",intval($Provider_id));  ?></TD>
                    </TR>
                    <TR>
            ...
            <TD colspan="2"><?php echo $FUNCTIONS->select_muliti_type("select subject_name,subject_id from `{$INFO[DBPrefix]}subject` where subject_open=1 order by subject_num desc ","subject_id","subject_id","subject_name",$SubjectId_array = explode(",",$Subject_id));?> <label>
                    ...
                    <TR>
                      <TD noWrap align=right width="17%"><?php echo $Admin_Product[ProductName];//商品名称：?>：</TD>
                      <TD colSpan=2><?php echo $FUNCTIONS->Input_Box('text','goodsname',$Goodsname,"  id='goodsname'   maxLength=50 size=40 ")?>
                    ...
                    <TR>
                     <TR>
                      ...
                      <TD colSpan=2><?php echo $FUNCTIONS->Input_Box('text','sale_name',$sale_name,"  id='sale_name'   maxLength=50 size=40 ")?>&nbsp;&nbsp;
                      顏色：
					  <?php echo $FUNCTIONS->Input_Box('text','salename_color',$salename_color,"    maxLength=10 size=10  ")?>&nbsp;&nbsp;<INPUT   onclick='select_color(1);' type=button value=<?php echo $Basic_Command['Please_Select'];?> name=button></TD></TR>
					<?php
                    if (!$_POST[doaction]=='copy'){
					?>
                    <TR>
                      <TD noWrap align=right width="17%"><?php echo $Admin_Product[Bn];//货号：?>：</TD>
                      <TD colSpan=2><?php echo $FUNCTIONS->Input_Box('text','bn',$Bn,"  id='bn'    maxLength=30 size=30 readonly=readonly ")?>
                    ...
                    <TR>
                     ...
                     <TR>
                      ...
                      <TD colSpan=2><?php echo $FUNCTIONS->Input_Box('text','weight',$weight,"  id='weight'   maxLength=50 size=40 ")?>KG</TD>
 				    </TR>
                     <!--TR>
                    ...
                    <TR>
                      <TD noWrap align=right width="17%"><label for="price"><?php echo $Admin_Product[ProductSPrice];//市場價格?>：</label></TD>
                    ...
                    <TR>
                      <TD noWrap align=right width="17%"><label for="price"><?php echo $Admin_Product[ProductNetPrice];//網購價?>：</label></TD>
                    ...
                    <TR>
                      ...
                      <TD><INPUT  id="img"  type="file" size="40" name="img" >
                        &nbsp;&nbsp;&nbsp;&nbsp;
					  <div id="imgtips" class="tips"><?php echo $Admin_Product[UploadIntro] ?></div>					  </TD></TR>
                 <?php if (is_file("../".$INFO['good_pic_path']."/".$Mid_img)){?>
					...
					<TR>
					  ...
					  <div id="video_urltips" class="tips_big"><?php echo $Admin_Product[Video_Intro] ?></div>					 </TD>
					  </TR>
                    <TR>
                      <TD align=right valign="top" noWrap><?php echo $Admin_Product[Easy_intro];//简单描述：?>：</TD>
                      <TD colSpan=2><?php echo $FUNCTIONS->Input_Box('textarea','intro',$Intro," cols=80 rows=6  ")?></TD>
                    </TR>
                    <TR  id=alarmshowcontent>
                      <TD width="17%" align=right noWrap valign="top"><?php echo $Admin_Product[AlarmContent];//使用規則：?>：</TD>
                      <TD colSpan=2><?php echo $FUNCTIONS->Input_Box('textarea','alarmcontent',$AlarmContent,"  cols=80 rows=6  ")?></TD>
					</TR>
                    <TR>
                      <TD align=right valign="top" noWrap>KeyWords：</TD>
                      <TD colSpan=2><?php echo $FUNCTIONS->Input_Box('textarea','keywords',$Keywords," cols=80 rows=6  ")?></TD>
                    </TR>
                    <TR>
                      <TD noWrap align=right>&nbsp;</TD>
                      <TD>&nbsp;</TD>
            ...
            促銷價格<?php echo $FUNCTIONS->Input_Box('text','saleoffprice',$saleoffprice,"      maxLength=10 size=10 ")?>
                  ...
                  width="100%" bgColor=#f7f7f7 border=0  id="showtable_cap" style="display:none">
                    ...
                    <TR>
                      ...
                      <TD colSpan=2><?php
                              $oFCKeditor = new FCKeditor('cap_des') ;
                              $sBasePath =  OtherPach."/".Resources."/FCKeditor/";
                              $oFCKeditor->Width		= '700' ;
                              $oFCKeditor->Height		= '400' ;
                              $oFCKeditor->BasePath	= $sBasePath ;
                              $oFCKeditor->Value		= $cap_des;
                              $oFCKeditor->Create() ;
  						    ?></TD>
                      </TR>
                      <TR>
