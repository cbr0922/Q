...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
       ...
       // var base = "/LiveEditor/images"; /*Relative to Root*/
		var thepathname = window.location.pathname;	//=> /nmanagerprov10test/admin/editor/common/assetmanager_new/asset.asp
		thepathname= thepathname.replace("admin/editor/assetmanager/asset.php","");	
		var base = thepathname+"assets";
        ...
        function panelUpload() {
        	if(flashUpload) {
                ...
                $("body", d).append([
                    ...
                    "<input type='submit' name='act' value='<?php echo FILEMANAGER_10?>' /></form>"
...
<body style="margin:0px;background:#ffffff;font-family:Arvo;font-size:12px">
    ...
    <div id="topPanel" style="display:block;top:0px;left:0px;width:100%;padding:15px;background:#fcfcfc;border-bottom:#f7f7f7 1px solid;border-right:#f7f7f7 1px solid">
        ...
        <div style="margin-top:5px;margin-bottom:5px;">
            <a id="lnkNewFolder" href="javascript:panelFolder()" style="margin-right:10px;font-size:10px;color:#000;"><?php echo FILEMANAGER_11?></a>
            <a id="lnkUpload" href="javascript:upload()" style="margin-right:10px;font-size:10px;color:#000;"><?php echo FILEMANAGER_10?></a>
        </div>
        ...
        <div id="divPreview" style="margin-top:15px;padding:15px;padding-bottom:14px;border:#f3f3f3 1px solid;background:#fefefe;">
            ...
            <a href="#" style="float:right;margin-right:2px;" onclick="$('#divPreview').slideToggle(750, 'easeOutBounce');"><?php echo SMARTLINKS_16?></a>
        </div>
        ...
        <div id="divNewFolder" style="margin-top:15px;padding:15px;height:65px;border:#f3f3f3 1px solid;background:#fefefe;">
            <h3 style="margin-top:0px"><?php echo FILEMANAGER_11?></h3>
