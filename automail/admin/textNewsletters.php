...
$rowsPerPage 	= 30;	//for the listing
...
<form method="get" action="textNewsletters.php" name="formfilter">
<table width="960px" border="0">
	<tr>
		<td valign="top">
			<span class="title"><?php echo ALLNEWSLETTERS_28; ?></span>
			<br><br>
			<a href="sendTextNewsletterForm.php"><?php echo ADMIN_HEADER_45; ?></a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<option value="textNewsletters.php?formfilter=0&sort=<?php echo $sort;?>" <?php if ($pformfilter=="0"){echo " selected";}?>><?php echo ALLNEWSLETTERS_4; ?></option>
			<option value="textNewsletters.php?formfilter=-1&sort=<?php echo $sort;?>" <?php if ($pformfilter=="-1") {echo " selected";}?>><?php echo ALLNEWSLETTERS_22; ?></option>
			<option value="textNewsletters.php?formfilter=-2&sort=<?php echo $sort;?>" <?php if ($pformfilter=="-2") { echo " selected";}?>><?php echo ALLNEWSLETTERS_23; ?></option>
			<option value="textNewsletters.php?formfilter=-3&sort=<?php echo $sort;?>" <?php if ($pformfilter=="-3"){ echo " selected";}?>><?php echo ALLNEWSLETTERS_24; ?></option>
			<option value="textNewsletters.php?formfilter=-4&sort=<?php echo $sort;?>" <?php if ($pformfilter=="-4") {echo " selected";}?>><?php echo ALLNEWSLETTERS_25; ?></option>
			</select>
		</td>
		<td valign="top" align=right>
				<img src="./images/textnewsletter.png" width='60' height='57'>
		</td>
	</tr>
</table>
</form>
...
<?php
//get newsletters
//$mySQL="SELECT idNewsletter, attachment, name, sent, DATE_ADD(dateSent, INTERVAL ".$pTimeOffsetFromServer." HOUR) as dateSent, DATE_ADD(dateCreated, INTERVAL ".$pTimeOffsetFromServer." HOUR) as dateCreated, nPisPubliccreatedBy FROM newsletter WHERE html=0";
$limitSQL 		= " LIMIT $offset, $rowsPerPage";
$mySQL="SELECT idNewsletter, attachments, name, sent, dateSent, dateCreated, isPublic, createdBy FROM ".$idGroup."_newsletters WHERE idGroup=".$idGroup." AND html=0";
if ($sort=="NASC") {
...
if (!$rows){
	...
	$countSQL="SELECT count(*) from ".$idGroup."_newsletters where idGroup=$idGroup AND html=0 $strSQL2";
...
<tr>
	...
	<td class="text headerCell" align="left"><?php echo ALLNEWSLETTERS_5; ?></td>
	<td class="<?php echo $dateFormatsorter?> headerCell"><?php echo ALLNEWSLETTERS_20; ?></td>
	<td class="<?php echo $dateFormatsorter?> headerCell" align=left><?php echo ALLNEWSLETTERS_12; ?></td>
...
<tr onMouseOver="this.bgColor='#f4f4f9';" onMouseOut="this.bgColor='#ffffff';">
	...
	<td class="listingCell" width=300><div style="float:left;width:280px;border:#333 0px solid"><?php echo $row['name']?></div><div style="float:right;margin-left:0px"><a href="#" onclick="popUpLayer('<?php echo $row['name']?>','previewTextNewsletter.php?idNewsletter=<?php echo $row['idNewsletter']?>',750,500);return false;"><img src="./images/magnifier.png"  width="18" height="18" border=0 title="<?php echo ALLNEWSLETTERS_15; ?>"></a></div></td>
	...
	<td class="listingCell" align="center" valign="bottom"><a href=# onclick="openConfirmBox('delete.php?idNewsletter=<?php echo $row['idNewsletter']?>&redirecturl=text','<?php echo fixJSstring(CONFIRM_5) .'<br>'. fixJSstring(GENERIC_2);?>');return false;"><img src="./images/delete.png"  width="18" height="18" border="0" title="<?php echo ALLNEWSLETTERS_14; ?>"></a></td>
	<td class="listingCell" align="center"><a href="sendTextNewsletterForm.php?idNewsletterEdit=<?php echo $row['idNewsletter']?>"><img src="./images/openEdit.png" width="20" height="19" border=0 title="<?php echo ALLNEWSLETTERS_16; ?>"></a></td>
