...
$Sql = " select * from `{$INFO[DBPrefix]}advertising` where adv_display = 1 and adv_type=3 and adv_tag='banner_right' and (start_time='' or start_time<='" . time() . "') and (end_time='' or end_time>='" . time() . "') order by orderby limit 0,3";
$Query = $DB->query($Sql);
...
$tpl->assign("advNum",     $Num);
$tpl->display("adv_banner_right.html");
?>
