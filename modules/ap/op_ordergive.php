...
while($Rs_order=$DB->fetch_array($Query_order)){
	//echo $Rs_order['flightdate']."<br>";
	$Array =  array("Order_id"=>$Rs_order['order_id'],"orderid"=>$Rs_order['order_serial'],"truename"=>$Rs_order['true_name']);
	
	$SMTP->MailForsmartshop($Rs_order['email'],"",37,$Array);
}
