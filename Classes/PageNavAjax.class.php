...
class PageItem {
	...
	function PageUrl($page)
	{
		...
		*/
		$link = "javascript:getshoplist(" . $page . ")";
		return $link;
	}
	...
	function PageButton()
	{
		...
		// $PageNavClass_Pack['Pre_Page'] = "上一页";
		//$PageNavClass_Pack['First_Page']  = "首页";
		// $PageNavClass_Pack['Last_Page']   = "最后页";
		// $PageNavClass_Pack['Next_Page']   = "下一页";
		// $PageNavClass_Pack['Pre_Page']    = "上一页";
	...
	* */
	...
	function SelectItem()
	{
		...
		global $PageNavClass_Pack;
		$SelectItem = " ";
		$SelectItem .= $PageNavClass_Pack['TurnTo']."<SELECT name='topage' size='1' onchange='getshoplist(this.value)'>\n";
		for($i = 1;$i <= $this->iPages;$i++) {
			if ($this->CPages == $i)
			$extra = "selected";
			else
			$extra = "";
			$SelectItem .= "<OPTION VALUE='" . $i . "' $extra>$i</OPTION>";
		}
		$SelectItem .= "</SELECT>\n";
		return $SelectItem;
	}
