...
define("ANGLE_STEP", 1);    //定义画椭圆弧时的角度步长 
...
// 绘图主函数，并输出图片 
// $datLst 为数据数组, $labLst 为标签数组, $clrLst 为颜色数组 
// 以上三个数组的维数应该相等 
function draw_img($datLst,$labLst,$clrLst,$fileName="none",$a=125,$b=60,$v=10,$font=10) 
{ 
    $ox        =    5+$a; 
    $oy        =    5+$b; 
    ...
    { 
        ...
        ImageTTFText($img, $font, 0, 5+2*$fw, $ly+13, $clrt, "../ttf/verdana.ttf", $str.":".$datLst[$i]."(".(round(10000*($datLst[$i]/$tot))/100)."%)"); 
        $ly        +=    $fh+2; 
    } 
   ...
   // header("Content-type: image/png"); 
    ...
    //输出生成的图片 
    $imgFileName = "../UploadFile/img/".$fileName.".png"; 
