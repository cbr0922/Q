...
//获得导航拦上的产品分类
$Sql_bclass    = "select bid,catname,pic1,pic2 from `{$INFO[DBPrefix]}bclass` where catiffb=1 and top_id=1 order by catord  asc  ";
...
$tpl->display("include_product_class_menu.html");
?>
