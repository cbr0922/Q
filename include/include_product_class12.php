...
//if (intval($_GET['bid'])==0){
	$Sql_bclass    = "select bid,catname,pic1,pic2,subject_id,subject_id2 from `{$INFO[DBPrefix]}bclass` where catiffb=1 and top_id=0  order by catord  asc  ";
//}else{
...
$tpl->display("include_product_class12.html");
?>
