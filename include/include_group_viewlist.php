...
$Sql = "select g.groupname, g.groupbn, g.groupSimg,g.gdid,g.price,g.intro,g.groupprice from `{$INFO[DBPrefix]}groupdetail` as g where g.ifpub=1 and g.ifrecommend=1 and (g.bid='" . $bid . " '" . $Add . ") order by g.view_num desc limit 0,5";
$Query = $DB->query($Sql);
...
$tpl->assign($Good);
$tpl->display("include_group_viewlist.html");
?>
