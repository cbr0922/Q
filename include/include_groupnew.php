...
$Sql = "select g.groupname, g.groupbn, g.groupMimg,g.gdid,g.price,g.intro,g.groupprice,g.saleoff_endtime,g.saleoff_starttime,g.groupbn,g.salename from `{$INFO[DBPrefix]}groupdetail` as g where g.ifpub=1 order by g.pubtime desc limit 0,5";
$Query = $DB->query($Sql);
...
$tpl->assign($Good);
$tpl->display("include_groupnew.html");
?>
