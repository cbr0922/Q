 ...
 **************************************************************** **/
	function _topNav() {
		...
		// Srearch
		jQuery('li.search .searchicon').click(function () {
		...
		if(jQuery('#header li.search .searchicon').size() != 0) {
			jQuery('#header .search-box, #header li.search .searchicon').on('click', function(e){
				e.stopPropagation();
			});
		...
		jQuery(".menudown .fa-angle-down").bind("click", function() {
			jQuery(this).next('ul.menudown1').slideToggle(150);
		});
		jQuery(".menudown1 .fa-angle-down").bind("click", function() {
			jQuery(this).next('ul.menudown2').slideToggle(150);
		...
		if(_header_el.hasClass('sticky')) {
			...
			if(jQuery("#brandheader").outerHeight()==0) {
				if(window.width > 768) {

					var _scrollTop 	= jQuery(document).scrollTop();
						_topBar_H 	= jQuery("#topBar").outerHeight()+1 || 0;
				...
				if(window.width > 1) {
					...
					var _scrollTop 	= jQuery(document).scrollTop();
						_topBar_H 	= jQuery("#header").outerHeight()+jQuery("#brandheader").outerHeight()+1 || 0;
						//alert(_topBar_H);
					...
					if(_scrollTop > _topBar_H) {
						...
						_header_el.addClass('fixed');
						jQuery('.brandsticky').addClass('fixed');
						...
						//_header_el.removeClass('fixed');
						_header_el.removeClass('fixed');
						jQuery('.brandsticky').removeClass('fixed');
