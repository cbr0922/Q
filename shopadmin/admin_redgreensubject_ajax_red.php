...
var optionslink = {
		success:       function(msg){
						if (msg=="1"){
							showpage("admin_redgreensubject_ajax_red_xlist.php","rgid=<?php echo $rgid;?>" ,"xlist");
								//closeWin();
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" id="show1">
        ...
        <tr>
          <td><FORM name=adminForm action="admin_redgreensubject_ajax_red_save.php" method=post id="dellinkform">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0"  id="show2">
                  ...
                  <TD align=center colSpan=2 height=31><TABLE width="100%" border=0 align="left" cellPadding=0 cellSpacing=0 class=p12black>
                      <TBODY>
                        <TR>
                          ...
                          <TD width="160"  height=31 align="left" vAlign=center class=p9black><a href="#"><img src="images/<?php echo $INFO[IS]?>/t_go.gif" border=0 id="linksearch"></a></TD>
                          <TD width="441" align="right" vAlign=center class=p9black><input type="button" name="detailsave" id="detailsave" value="保存" />
        ...
        <tr>
          <td><FORM name=adminForm action="admin_redgreensubject_ajax_red_save.php" method=post id="selectlinkgoodsform">
