...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
 ...
 getAttriClass('<?php echo $Bid?>');">基本資料</a></li>
             ...
             <?php if($INFO['Paytype']=="0"){?><li><a href="#" onClick="showtable('showtable_peisong');"> 配送設置</a></li><?php }?>

             <? if ($_GET['Action']=='Modi'){?><li><a href="#" onClick="showtajaxfun('goodssaleoffe');">買越多促銷</a></li>
             ...
             <li><a href="#" onClick="showtajaxfun('godos_action');">操作日誌</a></li><?php }?>
        ...
        <TBODY>
          ...
          <TR>
                  ...
                  width="100%" bgColor=#f7f7f7 border=0 id="showtable_base">
                          ...
                          <TBODY>
                            ...
                            <TR>
                              ...
                              <TD colspan="3"><?php echo $FUNCTIONS->Input_Box('text','goodsname',$Goodsname,"  id='goodsname'   maxLength=255 size=75 ")?></TD>
                            ...
                            <TR>
                              ...
                              <TD colspan="3"><div style="width:340px;float:left"><?php echo $FUNCTIONS->Input_Box('text','sale_name',$sale_name,"  id='sale_name'   maxLength=50 size=40 ")?></div>
                            ...
                            <TR <?php if ($_SESSION['LOGINADMIN_TYPE']==1 && $_SESSION['sa_type']==0){ echo "style='display:none;'"; }?>>
                              ...
                              <TD colspan="3"><?php echo $FUNCTIONS->Input_Box('radio','ifpub',$Ifpub,$Add=array($Basic_Command['Yes'],$Basic_Command['No']))?></TD>
            ...
            分<a href="#" class="easyui-tooltip" title="若不指定上架時間請保持空白，<br />上架商品必須是已審核，但已審核過了上架時間亦會下架"><img src="images/tip.png" width="16" height="16" border="0"></a>
                      ...
                      <TD colspan="3"><?php echo $FUNCTIONS->Input_Box('radio','ifshui',$ifshui,$Add=array("未稅","應稅"))?></TD>
                            ...
                            <TR>
                              ...
                              <TD colspan="3"><?php echo $FUNCTIONS->Input_Box('text','price',$Price,"  id='price'   maxLength=\"20\" size=\"20\" ")?>
                            ...
                            <TR>
                              ...
                              <TD colspan="3"><?php echo $FUNCTIONS->Input_Box('text','pricedesc',$Pricedesc,"  id='pricedesc'   maxLength=\"20\" onchange=\"getpmoney();\" size=\"20\"  ")?>
					  ...
					  ?></TD>
                            ...
                            <TR>
                              ...
                              <TD colspan="3"><?php echo $Pricedesc-$cost;?></TD>
					...
					?>
                            ...
                            <TR>
                              ...
                              <TD colSpan=3><?php echo $FUNCTIONS->select_type("select brandname,brand_id from `{$INFO[DBPrefix]}brand` order by brand_id asc  ","brand_id","brand_id","brandname",intval($Brand_id));  ?><?php //echo  // $FUNCTIONS->Input_Box('text','brand',$Brand,"      maxLength=40 size=40 ") ?></TD>
					...
					?>
                            ...
                            <TR>
                              ...
                              <TD width="14%"><!--div id="bntips" class="tips"><?php echo $Admin_Product[PleaseInputPrductBn]?></div-->					  <?php echo $goodsno;?></TD>
					...
					?>
                            ...
                            <TR>
                              ...
                              <TD align="left"><?php echo $FUNCTIONS->Input_Box('text','ERP',$ERP,"  id='ERP'   maxLength=255 size=20 ")?></TD>
					...
					?></TD>
                            ...
                            <TR>
                              ...
                              <TD colSpan=3><?php echo $FUNCTIONS->Input_Box('radio_alarm','ifalarm',$Ifalarm,$Add=array("貨到通知","開放預購"))?></TD>
