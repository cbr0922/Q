...
<title><?php echo $JsMenu[Product_Man];//商品管理?>--&gt;<?php echo $Admin_Product[SetMemberPrice];//会员价格设定?>--&gt;<?php echo $G_goodsname;?></title>
</HEAD>
...
function checkform(){
 	form1.action="admin_memberprice_save.php";
	form1.submit();
}
            ...
            <TABLE width="90%" border=0 cellPadding=0 cellSpacing=0>
              ...
              <TR>
                ...
                <TD class=p12black noWrap><SPAN
                  class=p9orange><?php echo $JsMenu[Product_Man];//商品管理?>--&gt;<?php echo $Admin_Product[SetMemberPrice];//会员价格设定?>--&gt;<?php echo $G_goodsname;?></SPAN></TD>
              </TR></TBODY></TABLE></TD>
                  ...
                  <TABLE height=33 cellSpacing=0 cellPadding=0 width=79 border=0>
                    ...
                    <TR>
					 <TD align=middle width=79>  <!--BUTTON_BEGIN-->
                        <TABLE class=fbottonnew link="admin_goodsdetail_list.php?Action=Modi&goods_id=<?php echo $gid?>">
                          <TBODY>
                          <TR>
                    ...
                    <TR>
					 <TD align=middle width=79>  <!--BUTTON_BEGIN-->
                        <TABLE>
                          ...
                          <TR>
                            <TD vAlign=bottom noWrap>
							<a href="admin_goodsdetail_list.php?Action=Modi&goods_id=<?php echo $gid?>"><IMG  src="images/<?php echo $INFO[IS]?>/fb-cancel.gif" border=0>&nbsp;<?php echo $Basic_Command['Cancel'];//取消?></a>&nbsp; </TD>
							</TR>
						  </TBODY>
						 </TABLE>
					 <!--BUTTON_END-->
                ...
                <TD bgColor=#ffffff>
                  <table width="100%"  border="0" cellspacing="2" bgcolor="#EBEBEB" class="p9black">
                    ...
                    <tr>
                      ...
                      <td  align="left" nowrap><?php echo $Admin_Product[Bn];//貨號?>：<?php echo $detail_bn?></td>
                      <td  align="left" nowrap><?php echo $Admin_Product[ProductName];//商品名称?>：<?php echo $detail_name?></td>
                      <td  align="left" nowrap><?php echo $Admin_Product[ProductPrice];//建議售價?>：<?php echo $detail_price?></td>
                      <td  align="left" nowrap><?php echo $Admin_Product[ProductNetPrice];//網購價?>：<?php echo $detail_pricedes?></td>
                      <td width="20%" align="right">&nbsp;</td>
                      </tr>
                    <tr height="30">
                  ...
                  <TABLE class=listtable cellSpacing=0 cellPadding=0    width="100%" border=0>
                    <FORM name=form1 action="admin_memberprice_save.php" method=post>
