...
if ($_GET['subject_id']!="" && $_GET['Action']=='Modi'){
	...
	$Query = $DB->query("select subject_name,subject_open,subject_num,subject_content from `{$INFO[DBPrefix]}subject` where subject_id=".intval($subject_id)." limit 0,1");
...
<TITLE><?php echo $JsMenu[Product_Man];//商品管理?>--&gt;<?php echo $JsMenu[Subject];?>--&gt;<?php echo $Action_say?></TITLE></HEAD>
...
<SCRIPT language=javascript>
	function checkform(){
	   ...
	   if (chkblank(form1.subject_name.value) || form1.subject_name.value.length>100){
		...
		form1.action="admin_subject_save.php";
		form1.submit();
    }
</SCRIPT>
<div id="contain_out">
<?php  include_once "Order_state.php";?>
  <FORM name=form1 action='admin_subject_save.php' method=post >
            ...
            <TD width="50%">
              <TABLE width="90%" border=0 cellPadding=0 cellSpacing=0>
                <TBODY>
                  ...
                  width=32></TD>
                    <TD class=p12black noWrap><SPAN  class=p9orange><?php echo $JsMenu[Product_Man];//商品管理?>--&gt;<?php echo $JsMenu[Subject];?>--&gt;<?php echo $Action_say?></SPAN></TD>
                </TR></TBODY></TABLE></TD>
