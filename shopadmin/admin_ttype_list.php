                  ...
                  <TR>
                      ...
                      <TABLE class=listtable cellSpacing=0 cellPadding=0   width="100%" border=0 id="orderedlist">
                          ...
                          <TBODY>
                            <TR align=middle>
                              ...
                              <TD align="center" noWrap background=images/<?php echo $INFO[IS]?>/bartop.gif class=p9black>廠商</TD>
                              ...
                              <TD align="center" noWrap background=images/<?php echo $INFO[IS]?>/bartop.gif class=p9black>類型</TD>
                               <TD align="center" noWrap background=images/<?php echo $INFO[IS]?>/bartop.gif class=p9black>貨運類型</TD>
                              <TD align="center" noWrap background=images/<?php echo $INFO[IS]?>/bartop.gif class=p9black>金流</TD>
					...
					?><TBODY>
                            <TR class=row0>
                              <TD width=80 height=20 align=center>
                                <INPUT id='cb<?php echo $i?>'  onclick=isChecked(this); type=checkbox value='<?php echo $Rs['transport_id']?>' name=cid[] <?php if($Rs['transport_id']==30 || $Rs['transport_id']==36){?>disabled<?php }?>></TD>
                              <TD height=20 align="left" noWrap>
                                <A href="javascript:toEdit('<?php echo $Rs['transport_id']?>',0);">
                                  <?php echo $Rs['transport_name']?>
                                </A></TD>
                              <TD align=center nowrap><?php echo $Rs['co_name']?></TD>
					...
					?>
                            <TR>
                              ...
                              <TD width=180 height=14>&nbsp;</TD>
                              <TD width=178>&nbsp;</TD>
                              <TD width=178 height=14>&nbsp;</TD>
                              <TD width=166>&nbsp;</TD>
                              <TD width=439>&nbsp;</TD>
                              <TD>&nbsp;</TD>
                              <TD>&nbsp;</TD>
