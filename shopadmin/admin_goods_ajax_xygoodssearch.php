...
?>
                  ...
                  <TABLE   width="95%" border=0 align="center" cellPadding=2 cellSpacing=0 class=listtable id="selectlinkgoodsform">

                    <FORM name=adminForm action="admin_goods_ajax_xygoodssave.php" method=post>
