...
function toExcel(){
		document.adminForm.target ="_self";
			document.adminForm.action = "provider_statistic_provider_sale_excel.php?<?php echo $restring;?>";
			document.adminForm.submit();
}
function toPrint(){
	document.adminForm.target ="_blank";
			document.adminForm.action = "provider_statistic_provider_sale_print.php?<?php echo $restring;?>";
			document.adminForm.submit();
}
//-->
</SCRIPT>
  ...
  <TR>    <TD width="1%" background=images/<?php echo $INFO[IS]?>/left.gif style="background-repeat: repeat-y;" height=319></TD>
    <TD vAlign=top width="100%" height=319>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
        <TR>
          <TD vAlign=top height=262><?php echo $current_month;?>月對帳銷售表<br>
                  <br>
                  <?php
                  if (intval($_GET['provider_id'])>0){
                        ...
                        <TD bgColor=#ffffff><TABLE class=listtable cellSpacing=0 cellPadding=0    width="100%" border=0>
                            <TBODY>
                              ...
                              <TR>
                                ...
                                <TD height=14 align="center"><?php echo $Rs['zhang'];?></TD>
                                <TD height=14></TD>
                              </TR>
                              <TR>
                                <TD height=14 nowrap>&nbsp;</TD>
