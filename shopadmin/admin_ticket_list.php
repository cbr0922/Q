              ...
              <TABLE width="90%" border=0 cellPadding=0 cellSpacing=0>
                <TBODY>
                  <TR>
                    ...
                    <TD class=p12black noWrap><SPAN class=p9orange>行銷工具--&gt;電子折價券管理--&gt;電子折價券</SPAN>
                      </TD>
              </TR></TBODY></TABLE></TD>
                        ...
                        <TR>
                          <TD align=middle width=79>
                            <TABLE>
                              <TBODY>
                                <TR>
                            <TD vAlign=bottom noWrap class="link_buttom"><a href="admin_ticket.php"><IMG  src="images/<?php echo $INFO[IS]?>/fb-new.gif"  border=0>&nbsp;新增折價券</a></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD>
                ...
                <TBODY>
                  ...
                  width="100%" border=0 id="orderedlist">
					...
					?><TBODY>
					  ...
					  if ($Rs['pub_starttime']!="" && $Rs['pub_endtime']!=""){
							$begtimeunix  = $TimeClass->ForYMDGetUnixTime($Rs['pub_starttime'],"-");
							$endtimeunix  = $TimeClass->ForYMDGetUnixTime($Rs['pub_endtime'],"-");
					  
						  if (time()>=$begtimeunix && time()<=$endtimeunix){
						  ?>
                                  <div class="link_box" style="width:100px;float:left"><a href="admin_ticketrecord_list.php?ticketid=<?php echo $Rs['ticketid']?>">發放折價券號碼</a></div>
                                  <?php
						  }
					  }else{
					  ?>
                                  <div class="link_box" style="width:100px;float:left"><a href="admin_ticketrecord_list.php?ticketid=<?php echo $Rs['ticketid']?>">發放折價券</a></div>
                                  <?php
					  }
					  }else{
					  ?>
                                  <div class="link_box" style="width:100px;float:left"><a href="admin_ticketcode.php?ticketid=<?php echo $Rs['ticketid']?>"><i class="icon-plus-sign"></i> 新增號碼</a></div><div class="link_box" style="width:100px;float:left"><a href="admin_ticketcode_list.php?ticketid=<?php echo $Rs['ticketid']?>">查看號碼列表</a></div>
                                  <?php
					  }
					  ?>
                                  
                                <div class="link_box" style="width:100px;float:left"><a href="admin_ticket_uselist.php?ticketid=<?php echo $Rs['ticketid']?>">折價券使用情況</a></div></TD>
                              </TR></TBODY>
                          <?php
					$i++;
					}
