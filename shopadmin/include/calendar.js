...
function loadcalendar() {
	s = '';
	s += '<div id="calendar" style="display:none; position:absolute; z-index:50;" onclick="_cancelBubble(event)">';
	s += '<div style="width: 200px;"><table class="tableborder" cellspacing="0" cellpadding="0" width="100%" style="text-align: center">';
	s += '<tr align="center" class="header"><td class="header"><a href="###" onclick="refreshcalendar(yy, mm-1)" title="上一月">《</a></td><td colspan="5" style="text-align: center" class="header"><a href="###" onclick="showdiv(\'year\');_cancelBubble(event)" title="點擊選擇年份" id="year"></a>&nbsp; - &nbsp;<a id="month" title="點擊選擇月份" href="###" onclick="showdiv(\'month\');_cancelBubble(event)"></a></td><td class="header"><A href="###" onclick="refreshcalendar(yy, mm+1)" title="下一月">》</A></td></tr>';
