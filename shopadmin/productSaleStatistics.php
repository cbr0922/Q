...
*/
$Sql = "select sum(od.goodscount*od.price) as smtotal,sum(od.goodscount) as sntotal,od.goodsname from `{$INFO[DBPrefix]}order_detail` as od inner join `{$INFO[DBPrefix]}order_table` as ot on od.order_id=ot.order_id where ot.createtime>='" . $begtimeunix . "' and ot.createtime<='" . $endtimeunix . "'  group by od.gid order by sntotal desc";
$Query    = $DB->query($Sql);
              ...
              <TABLE width="90%" border=0 cellPadding=0 cellSpacing=0>
                <TBODY>
                  <TR>
                    ...
                    <TD class=p12black noWrap><SPAN  class=p9orange><?php echo $JsMenu[Tools];//工具?>--><?php echo $JsMenu[TjFx];//统计分析?>--><?php echo $JsMenu[ProductVisit];//商品統計?>--&gt;商品銷售排行</SPAN></TD>
                </TR></TBODY></TABLE></TD>
                      ...
                      <TABLE height=33 cellSpacing=0 cellPadding=0 width=79 border=0>
                        ...
                        <TBODY>
                          <TR align="center">
						    ...
						    ?>
                                  <TR align="right">
                                    <TD height=30 colspan="6" class="p9orange" align="right">							   </TD>
                                    </TR>
                                  <?php
	             			}else{
						    ?>
