...
$Sql     = " select count(visit_ip_id) as totalvisit,referrer from `{$INFO[DBPrefix]}visit_ip` where visit_idate >='".$Begtime."' and visit_idate <= '".$Endtime."' and referrer!=''  group by referrer  order by totalvisit desc ";
$Query   = $DB->query($Sql);
...
<TITLE>
<?php echo $JsMenu[Tools];//工具?>--><?php echo $JsMenu[TjFx];//统计分析?>--><?php echo $JsMenu[Visit];//訪問統計?>--&gt;<?php echo $Visit_Packs[VisPageTotal];//来访页面分析?>
</TITLE></HEAD>
          ...
          <TD width="50%">
            <TABLE width="90%" border=0 cellPadding=0 cellSpacing=0>
              ...
              <TR>
                ...
                <TD class=p12black noWrap><SPAN  class=p9orange><?php echo $JsMenu[Tools];//工具?>--><?php echo $JsMenu[TjFx];//统计分析?>--><?php echo $JsMenu[Visit];//訪問統計?>--&gt;<?php echo $Visit_Packs[VisPageTotal];//来访页面分析?></SPAN></TD>
              </TR></TBODY></TABLE></TD>
					   ...
					   <TABLE class=listtable cellSpacing=0 cellPadding=0   width="100%" border=0>
                           <TBODY>
                             <TR align=middle class=row1>
                               ...
                               <TD align="left" noWrap background=images/<?php echo $INFO[IS]?>/bartop.gif class=p9black style1> <?php echo $Visit_Packs[HttpUrl];//URL地址?></TD>
						    ...
						    ?>   
                             <TR class=row0>
                               ...
                               <TD height=20 align="left" noWrap><?php echo $Result['referrer'];?></TD>
						    ...
						    ?>
							  <TR align="right">
							   <TD height=20 colspan="4" class="p9orange"><br>
							     <br>
