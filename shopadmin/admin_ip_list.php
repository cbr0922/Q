...
$Sql      = "select * from `{$INFO[DBPrefix]}adminip`  order by id  ";
$Query    = $DB->query($Sql);
...
function toEdit(id,catid){
	...
	if (checkvalue!=false){
		...
		document.adminForm.action = "admin_ip.php?Action=Modi&id="+checkvalue;
		document.adminForm.act.value="edit";
		document.adminForm.submit();
	}
}
function toNew(id,catid){
	    document.adminForm.action = "admin_ip.php";
		document.adminForm.submit();
...
function toDel(){
	...
	if (checkvalue!=false){
		if (confirm('<?php echo $Basic_Command['Del_Select']?>')){   //您是否确认删除选定的记录
			document.adminForm.action = "admin_ip_save.php";
              ...
              <TABLE width="90%" border=0 cellPadding=0 cellSpacing=0>
                <TBODY>
                  <TR>
                    ...
                    <TD class=p12black noWrap><SPAN class=p9orange><?php echo $JsMenu[Set];//设置?>--&gt;通行IP管理</SPAN>
                      </TD>
              </TR></TBODY></TABLE></TD>
                        ...
                        <TR>
                          <TD align=middle width=79><!--BUTTON_BEGIN-->
                            <TABLE>
                              <TBODY>
                                <TR>
                            <TD vAlign=bottom noWrap class="link_buttom"><a href="javascript:toNew();"><IMG  src="images/<?php echo $INFO[IS]?>/fb-new.gif"  border=0>&nbsp;新增IP</a></TD></TR></TBODY></TABLE><!--BUTTON_END--></TD></TR></TBODY></TABLE></TD>
                  <TD align=middle>
                    <TABLE height=33 cellSpacing=0 cellPadding=0 width=79 border=0>
                      <TBODY>
                        <TR>
                      ...
                      <FORM name=adminForm action="" method=post>
                          ...
                          <TBODY>
                            <TR align=middle>
                              ...
                              <TD  height=26 align="center" noWrap background=images/<?php echo $INFO[IS]?>/bartop.gif class=p9black style1>IP</TD>
					...
					?><TBODY>
                            <TR class=row0>
                              ...
                              <TD height=26 align="center" noWrap>
                                <A href="javascript:toEdit('<?php echo $Rs['id']?>',0);"> <?php echo $Rs['ip']?>&nbsp; </A></TD>
