...
$s = $Where." and  gid!=".$Gid." ";
$Sql      = "select * from `{$INFO[DBPrefix]}goods`  where ifgoodspresent=1 ".$s." order by goodorder ";
...
<div style="height:400px;overflow:auto">
       <FORM name=presentgoodsform method=get action="admin_goods_ajax_presentgoodssearch.php" id="presentgoodsform">        
        ...
        <TR>
          <TD align=center colSpan=2 height=31>
            <TABLE width="95%" border=0 align="center" cellPadding=0 cellSpacing=0 class=p12black>
              <TBODY>
              <TR>
                <TD width="317"   height=31 align=center nowrap  class=p9black><?php echo $Admin_Product[PleaseInputPrductName];//請輸入商品名稱?>&nbsp;
                 <INPUT  class='box1'  onmouseover="this.className='box2'" onMouseOut="this.className='box1'"   name='skey'>
				</TD>
                <TD width="57"  height=31 align="left" vAlign=center class=p9black>
		        &nbsp;&nbsp;&nbsp; <a href="#"><img src="images/<?php echo $INFO[IS]?>/t_go.gif" border=0 id="presentsearch"></a>
                </TD>
        	    <TD width="654" align="right" vAlign=center class=p9black>
				<input type="button" name="presentsave" id="presentsave" value="保存" />
    ...
    </FORM><FORM name=selectpresentgoodsform action="admin_goods_ajax_presentgoodssave.php" method=post id="selectpresentgoodsform">
					<INPUT type=hidden name=actpresent id="actpresent" value="Save">
	...
	<div id="goodspresentlist">
                  ...
                  <TABLE   width="95%" border=0 align="center" cellPadding=0 cellSpacing=0 class=listtable>
                    ...
                    <TR align=middle>
                      ...
                      <TD width="16%"  height=26 colspan="8" align="left" noWrap background=images/<?php echo $INFO[IS]?>/bartop.gif class=p9black><?php echo $Admin_Product[ProductPrice];//价格?>					  </TD>
                      </TR>
					<?php               
					$i=0;
                    ...
                    <TR class=row0>
                      ...
                      <TD height=20 colspan="8" align=left nowrap><?php echo $Rs['price']?><INPUT id='price<?php echo $i?>'  type=hidden value='<?php echo $Rs['price']?>' name=price[]></TD>
                      </TR>
					<?php
					$i++;
					}
...
$("#presentsearch").click(function(){
					  ...
					  // alert($("#linkgoodsform").attr("action"));
					   $("#presentgoodsform").ajaxSubmit(options);
								});
$("#presentsave").click(function(){$("#selectpresentgoodsform").ajaxSubmit(options1);});
});
</script>