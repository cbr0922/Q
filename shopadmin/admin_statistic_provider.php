    ...
    <TD vAlign=top width="100%" height=319>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                        ...
                        <TD valign="top" noWrap>
                            <FORM method=get action="" name="form2">
							 ...
							 <table width="98%"  border="0" align="center" class="p9black">
                                ...
                                <tr>
                                  <td width="15%" align="right"><?php echo $Admin_Product[Provider_name]?>：</td>
                                  <td width="85%" align="left"><select name="province">
								  ...
								  ?>
                                  <option value="<?php echo $provider_Rs['provider_id']?>" <?php if ($_GET['province']==$provider_Rs['provider_id']) echo "selected";?>><?php echo $provider_Rs['provider_name'] . "(" . $provider_Rs['provider_thenum'] . ")" ?></option>
                                  <?php
								  }
								  ?>
                                  </select>&nbsp;</td>
        ...
        <INPUT    id=endtime size=10 value=<?php echo $endtime?>      onclick="showcalendar(event, this)" onFocus="showcalendar(event,this);if(this.value=='0000-00-00')this.value=''"  name=endtime />
                  ...
                  <br>
                  <a href="#" onClick="document.all.showtable.style.display='block';document.all.showmap.style.display='none';">列表</a> | <a href="#" onClick="document.all.showtable.style.display='none';document.all.showmap.style.display='block';">圖表</a> | <a href="admin_statistic_provider2.php">供應商業績</a><br>
