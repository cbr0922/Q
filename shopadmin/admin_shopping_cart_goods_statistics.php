...
$Sql = "select sum(s.gcount) as sntotal,g.goodsname,g.gid";
$Sql .=	" from `{$INFO[DBPrefix]}shopping` as s";
$Sql .=	" left join `{$INFO[DBPrefix]}goods` as g on s.gid=g.gid";
$Sql .=	" where s.user_id!=0";
$Sql .=	" group by s.gid order by sntotal desc";
...
<TITLE>行銷工具--&gt;統計分析--&gt;商品統計--&gt;購物車商品統計</TITLE>
</HEAD>
              ...
              <TABLE width="90%" border=0 cellPadding=0 cellSpacing=0>
                <TBODY>
                  <TR>
                    ...
                    <TD class=p12black noWrap><SPAN class=p9orange>行銷工具--&gt;統計分析--&gt;商品統計--&gt;購物車商品統計</SPAN></TD>
                </TR></TBODY></TABLE></TD>
					  ...
					  <table id="itemTable" class="tablesorter">
						...
						<tbody id="listBox">
							...
							<tr>
								...
								<td align="center" class="p9black link_box"><a href="admin_shopping_cart_goods_statistics_save.php?gid=<?php echo $Results[$i]['gid'];?>" target="_blank">保存郵件組</a></td>
							</tr>
							<script>
								$(function() {
