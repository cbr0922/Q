...
$Sql      = "select  g.*,bc.catname from `{$INFO[DBPrefix]}goods` g  left join `{$INFO[DBPrefix]}bclass`  bc  on (g.bid=bc.bid)  where g.ifpresent=1  ".$Where." ";
...
<TITLE><?php echo $JsMenu[Product_Man];//商品管理?>--&gt;額滿禮商品</TITLE>
</HEAD>
              ...
              <TABLE cellSpacing=0 cellPadding=0 border=0>
                <TBODY>
                  <TR>
                    ...
                    <TD class=p12black noWrap><SPAN class=p9orange><?php echo $JsMenu[Product_Man];//商品管理?>--&gt;額滿禮商品</SPAN></TD>
              </TR></TBODY></TABLE></TD>
        ...
        <FORM name=optForm method=get action="">        
          ...
          <TR>
            <TD align=left colSpan=2 height=31>
              <TABLE border=0 cellPadding=0 cellSpacing=0 class=p12black>
                <TBODY>
                  <TR>
                    <TD height=31 align=left>
                      <INPUT  name='skey'  onfocus=this.select()  onclick="if(this.value=='<?php echo $Admin_Product[PleaseInputPrductName]?>')this.value=''"  onmouseover=this.focus() value='<?php echo $Admin_Product[PleaseInputPrductName]?>' size="30">
                      <INPUT type=image src="images/<?php echo $INFO[IS]?>/t_go.gif" border=0 name=imageField align="absmiddle">                </TD>
                  </TR>
                </TBODY>
              </TABLE>
            </TD>
            <TD width="13%" height=31 align=right class=p9black><?php echo $Basic_Command['PerPageDisplay'];//每页显示?> 
                  ...
                  <TR>
                        ...
                        <FORM name=adminForm action='' method=post>
                          ...
                          <TBODY>
                            <TR align=middle>
                              ...
                              <TD width="10%"  height=26 align="left" noWrap background=images/<?php echo $INFO[IS]?>/bartop.gif class=p9black><?php echo $Admin_Product[Bn];//货号?></TD>
                              <TD width="20%"  height=26 align="left" noWrap background=images/<?php echo $INFO[IS]?>/bartop.gif class=p9black>
                                <?php echo $Admin_Product[PrductClassName];//商品類別名稱?>					  </TD>
                              <TD width="32%" align="left" noWrap background=images/<?php echo $INFO[IS]?>/bartop.gif class=p9black><?php echo $Admin_Product[ProductName];//商品名稱?>&nbsp;</TD>
                              <TD width="11%" align="center" background=images/<?php echo $INFO[IS]?>/bartop.gif class=p9black>額滿禮金額</TD>
                              ...
                              <TD width="7%"  height=26 background=images/<?php echo $INFO[IS]?>/bartop.gif class=p9black><?php echo $Admin_Product[pub];//发布?><BR></TD>
                              <TD width="10%"  height=26 align="center" noWrap background=images/<?php echo $INFO[IS]?>/bartop.gif class=p9black><?php echo $Admin_Product[storage];//库存?><BR></TD>
                            </TR>	
                            <?php               
					$i=0;
					...
					?>
                            <TR class=row0>
                              ...
                              <TD align=center><?php echo $Rs['present_money']?></TD>
