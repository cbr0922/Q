...
if ($_GET['action']=='search') {
	...
	if (trim($_GET['type'])=='od.goodsname'){
	 ...
	 $Sql = " select  u.true_name,o.order_serial,o.order_id,o.createtime,o.totalprice,o.transport_price,
			 ...
			 if(trim($_GET['State'])=="NoOp")
			 	...
			 	$Sql      .= " o.createtime>='$begtimeunix' and o.createtime<='$endtimeunix' and ((o.order_state=3 and o.transport_state<>18) or (o.order_state=1 and o.transport_state=18) )";
	...
	if(trim($_GET['State'])=="NoOp"||trim($_GET['State'])=="Cancel"||trim($_GET['State'])=="Back")
	  ...
	  $sSql      = " o.createtime>='$begtimeunix' and o.createtime<='$endtimeunix' and ((o.order_state=3 and o.transport_state<>18) or (o.order_state=1 and o.transport_state=18) ) ";
