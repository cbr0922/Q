        ...
        <TBODY>
          <TR>
            ...
            <ul>
             ...
             <li><a href="javascript:changeOrderState(1,1);">確定</a></li>
             ...
             <!--li><a href="javascript:toPrintDown(<?php echo $Order_id?>)">下載Excel檔</a></li-->
            </ul>
            </div>
           </TD>
            </TR>
				...
				$Departure = $Rs['Departure'];
					 ...
					 ?>
                          <TBODY>
                            <TR align=middle>
                              ...
                              <td width="60" align="center" nowrap="nowrap"  background=images/<?php echo $INFO[IS]?>/bartop.gif class=p9black style1>顏色/尺寸</td>
                              <TD align="center" noWrap background=images/<?php echo $INFO[IS]?>/bartop.gif class=p9black style1> <?php echo $Order_Pack[AlsendProductNum];//已发货数量?></TD>
                              <TD align="center" noWrap background=images/<?php echo $INFO[IS]?>/bartop.gif class=p9black style1> <?php echo $Order_Pack[NeedsendProductNum];//需发货数量?></TD>
                              <TD align="center" noWrap background=images/<?php echo $INFO[IS]?>/bartop.gif class=p9black style1> <?php echo $Order_Pack[Items_xj_say];//单项小计?></TD>
					...
					?>
						...
						?>
                              ...
                              <TD height=20 align="center" noWrap>
                                <?php if ($Rs_d['packgid']==0) echo $buyprice?>&nbsp;</TD>
                              <TD height=20 align="center" noWrap>
                                <?php echo $Rs_d['goodscount']?>&nbsp;<?php echo $Rs_d['unit']?></TD>
                              <TD height=20 align="center" noWrap>
                                <?php echo $Rs_d['good_color']?>/<?php echo $Rs_d['good_size']?>&nbsp;</TD>
                              <TD height=20 align="center" noWrap>
              ...
              <table width="100%" border="0" align="left" cellpadding="4" cellspacing="0" bgcolor="#F7F7F7"   class="allborder">
                ...
                <tr>
                  ...
                  <td width="16%" align="right" valign="top" nowrap class="p9orange"><?php echo $Cart[send_money_say];//配送費用?>
                    ：</td>
                  <td width="39%" nowrap><?php echo $Transport_price?>元</td>
                  </tr>
                <?php
                 if ($Rs['ifgroup']==1){
				?>
                <tr>
                  <td align="right" valign="top" nowrap class="p9orange">團購點數：</td>
                  <td nowrap><?php echo $totalGrouppoint;?></td>
                ...
                <tr>
                  <td align="right" valign="top" nowrap class="p9orange">使用折扣券：</td>
				...
				?>
                <tr>
                  <td align="right" valign="top" nowrap="nowrap" class="p9orange">紅利兌換點數：</td>
                  <td nowrap="nowrap"><?php echo $totalbonuspoint;?>點</td>
                  <td align="right" valign="top" nowrap="nowrap" class="p9orange"><?php echo $Cart[pay_type_say];//付款方式?> ：</td>
                  <td nowrap="nowrap"><?php echo $Paymentname?></td>
                </tr>
                ...
                <tr>
                  <td align="right" valign="top" nowrap="nowrap" class="p9orange">發票號碼：</td>
                  <td nowrap="nowrap"><?php echo $invoice_code;?></td>
                  <td align="right" valign="top" nowrap class="p9orange">載具類型：</td>
                  <td nowrap>
                  <?php
                ...
                <tr>
                  <td align="right" valign="top" nowrap="nowrap" class="p9orange">物流號碼：</td>
                  <td nowrap="nowrap"><?php echo $piaocode;?></td>
                ...
                <tr>
                  <td align="right" valign="top" nowrap class="p9orange">超商繳款編號：</td>
                  <td nowrap><?php echo $paycode;?>&nbsp;</td>
                  <td align="right" valign="top" nowrap class="p9orange">取貨門市：</td>
                  <td nowrap><?php echo $storename;?></td>
                  </tr>
                <tr>
                  <td align="right" valign="top" nowrap class="p9orange">配送日期：</td>
                  <td nowrap><?php echo $senddate;?></td>
                  <td align="right" valign="top" nowrap class="p9orange">班機號碼：</td>
                  <td nowrap><?php echo $flightid.$flightno;?>&nbsp;</td>
                </tr>
                <tr>
                  <td align="right" valign="top" nowrap class="p9orange">目的地：</td>
                  <td nowrap><?php echo $Departure;?></td>
                  <td align="right" valign="top" nowrap class="p9orange">直飛/轉機：</td>
                  <td nowrap><?php echo $flightstyle=="direct"?"直飛":"轉機";?>&nbsp;</td>
                </tr>
                 <tr>
                  <td align="right" valign="top" nowrap class="p9orange">班機時間：</td>
                  <td nowrap><?php echo $Departure;?></td>
                  <td align="right" valign="top" nowrap class="p9orange">直飛/轉機：</td>
                  <td nowrap><?php echo $flightdate;?>&nbsp;</td>
                </tr>
              </table></td>
          </tr>
          </table>
			...
			?>
              <table width="100%" border="0" cellspacing="0" cellpadding="4"   class="allborder" bgcolor="#F7F7F7">
                <tr>
                  ...
                  <tr>
                  <td width="18%" align="right" valign="top" nowrap class="p9orange"> 英文名：
                    ：</td>
                  <td width="27%" align="left" nowrap>
                    <?php echo $Result_user['en_firstname']?> <?php echo $Result_user['en_secondname']?>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  <td width="16%" align="right" valign="top" nowrap class="p9orange">護照號：
                    ：</td>
                  <td width="39%" align="left" nowrap>
                    
                    <?php echo $Result_user['certcode']?>
                    </td>
                  </tr>
                <tr>
                  ...
                  <td width="27%" align="left" nowrap>
                    ...
                    <span class="STYLE2"> /</span>                    <?php echo MD5Crypt::Decrypt ( trim($Result_user['other_tel']), $INFO['mcrypt'])//$Result_user['other_tel']?></td>
                ...
                <tr>
                  <td width="18%" align="right" valign="top" nowrap class="p9orange"><?php echo $Admin_Member[Area];//地區?>
                    ：</td>
                  <td align="left"><?php echo $Result_user['Country'].$Result_user['canton'].$Result_user['city']?></td>
                  <td align="right"><span class="p9orange">
                    <?php echo $Admin_Member[Post];//邮政编码?>：</span></td>
                  <td align="left"><?php echo $Result_user['zip']?></td>
                </tr>
                <tr>
                  <td align="right" valign="top" nowrap class="p9orange"><?php echo $Admin_Member[Address];//地址?>
                    ：</td>
                  <td><?php echo $Result_user['addr']?></td>
