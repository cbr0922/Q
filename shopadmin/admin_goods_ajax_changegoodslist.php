...
<div style="height:400px;overflow:auto">
       <FORM name=optForm method=get action="admin_goods_ajax_changegoodssearch.php" id="linkgoodsform">        
        ...
        <TR>
          <TD align=center colSpan=2 height=31>
            <TABLE width="95%" border=0 align="center" cellPadding=0 cellSpacing=0 class=p12black>
              <TBODY>
              <TR>
                <TD width="288"   height=31 align=center nowrap  class=p9black><?php echo $Admin_Product[PleaseInputPrductName];//請輸入商品名稱?>&nbsp;
                 <INPUT  class='box1'  onmouseover="this.className='box2'" onMouseOut="this.className='box1'"   name='skey'>
				</TD>
                <TD width="84"  height=31 align="left" vAlign=center class=p9black>
		        &nbsp;&nbsp;&nbsp; <a href="#"><img src="images/<?php echo $INFO[IS]?>/t_go.gif" border=0 id="linksearch"></a>
                </TD>
        	    <TD width="656" align="right" vAlign=center class=p9black>
