                  ...
                  <TR>
                    <TD vAlign=top bgColor=#ffffff height=300>
                      ...
                      <TD align=left noWrap>&nbsp;</TD>
                          ...
                          <TR>
                            <TD noWrap align=right>購物車使用紅利：</TD>
                            <TD colspan="3" align=left noWrap><input type="radio" name="cart_usebonus" value="1" <?php if (intval($INFO['cart_usebonus'])==1){ echo " checked ";} ?> >
                              開啟
                              <input type="radio" name="cart_usebonus" value="0" <?php if (intval($INFO['cart_usebonus'])==0){ echo " checked ";} ?> >
                              關閉&nbsp;</TD>
                          </TR>
                          <TR>
                            <TD noWrap align=right>購物車使用折價券：</TD>
                            <TD colspan="3" align=left noWrap><input type="radio" name="cart_useticket" value="1" <?php if (intval($INFO['cart_useticket'])==1){ echo " checked ";} ?> />
開啟
...
關閉</TD>
                          ...
                          <TR>
                            <TD noWrap align=right>商品評價贈送紅利：</TD>
                            <TD colspan="3" align=left noWrap><?php echo $FUNCTIONS->Input_Box('text','commnetPoint',$INFO['commnetPoint'],"          maxLength=30 size=10  ")?></TD>
                          </TR>
                          <TR>
                          ...
                          <TR>
                            <TD noWrap align=right>全館贈品：</TD>
                            <TD colspan="3" align=left noWrap><?php echo $FUNCTIONS->Input_Box('text','allsaleoff_present',$INFO['allsaleoff_present'],"          maxLength=30 size=10  ")?>*請填寫貨號</TD>
                          </TR>
                          <TR>
							...
							?>
                          <TR>
                            <TD noWrap align=right>郵件發送設定：</TD>
