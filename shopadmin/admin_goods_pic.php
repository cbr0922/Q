...
<TABLE cellSpacing=0 cellPadding=0 width="97%" align=center border=0>
  <FORM  action='admin_goods_pic_save.php' method=post enctype='multipart/form-data' 	name='upload' onSubmit="return picsubmit()" >
                ...
                <TD align=middle>
                  <TABLE height=33 cellSpacing=0 cellPadding=0 width=79 border=0>
                    ...
                    <TR>
					  ...
					  <!--BUTTON_BEGIN-->
                        <TABLE class=fbottonnew link="admin_goods.php?Action=Modi&gid=<?php echo $Good_id?>">
                          <TBODY>
                          <TR>
                  ...
                  <TABLE height=33 cellSpacing=0 cellPadding=0 width=79 border=0>
                    ...
                    <TR>
                      <TD align=middle width=79><!--BUTTON_BEGIN-->
                        <TABLE class=fbottonnew border=0 link="javascript:picsubmit();">
						 <TBODY>
                          <TR>
                    ...
                    <TR>
                      <TD align=middle width=79><!--BUTTON_BEGIN-->
                        <TABLE>
						 <TBODY>
                          <TR>
                            <TD vAlign=bottom noWrap ><a href="javascript:picsubmit();"><IMG src="images/<?php echo $INFO[IS]?>/fb-save.gif" border=0 >&nbsp;<?php echo $Basic_Command['Save'];//保存?></a>&nbsp; </TD></TR></TBODY></TABLE><!--BUTTON_END-->
