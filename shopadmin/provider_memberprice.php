...
function checkform(){
 	form1.action="provider_memberprice_save.php";
	form1.submit();
}
					 ...
					 <TD align=middle width=79>  <!--BUTTON_BEGIN-->
                        <TABLE>
                          ...
                          <TR>
							...
							<a href="provider_goods.php?Action=Modi&gid=<?php echo $gid?>"><IMG  src="images/<?php echo $INFO[IS]?>/fb-cancel.gif" border=0>&nbsp;<?php echo $Basic_Command['Cancel'];//取消?></a>&nbsp; </TD>
							</TR>
						  </TBODY>
						 </TABLE>
					 <!--BUTTON_END-->
              ...
              <TR>
                <TD bgColor=#ffffff>
                  ...
                  <TABLE class=listtable cellSpacing=0 cellPadding=0    width="100%" border=0>
                    <FORM name=form1 action="provider_memberprice_save.php" method=post>
                    ...
                    <TR class=row0>
					  ...
					  <?php
					  $Sql_M    = "select * from `{$INFO[DBPrefix]}member_price` where m_level_id=".intval($Rs['level_id'])." and m_goods_id=".intval($gid)." limit 0,1";
