...
if($_SESSION['LOGINADMIN_TYPE']==1 && !in_array($Bid,$class_array) && intval($_GET['gid'])>0){
  ...
  <TR>
    <TD vAlign=top width="100%" height=319>
                    ...
                    <TABLE height=33 cellSpacing=0 cellPadding=0 width=79 border=0>
                      <TBODY>
                        <TR>
                          ...
                          <?php if (($_SESSION['LOGINADMIN_TYPE']==1 && $_SESSION['sa_type']==1) || $_SESSION['LOGINADMIN_TYPE']==0){?>
                          <td align=middle><table height=33 cellspacing=0 cellpadding=0 width=79 border=0>
                            <tbody>
                              <tr>
                                <td align=middle width=79><!--BUTTON_BEGIN-->
      ...
      <table border="0" cellspacing="0">
        <tr>
          <td height="25" valign="top"> <a href="#" onClick="showtable('showtable_base');getMoreAttrib('<?php echo $Bid?>');
 getAttriClass('<?php echo $Bid?>');">基本資料</a> | <a href="#" onClick="showtable('showtable_cuxiao');">促銷</a> |  <?php if($INFO['Paytype']=="0"){?><a href="#" onClick="showtable('showtable_peisong');"> 配送設置</a> |<?php }?> <a href="#" onClick="showtable('showtable_tag');">TAG</a><? if ($_GET['Action']=='Modi'){?> | <a href="#" onClick="showtajaxfun('goodssaleoffe');">買越多促銷</a> <!--| <a href="#" onClick="showtajaxfun('memberprice');">商品會員價格</a--> | <a href="#" onClick="showtajaxfun('attrib');">商品多屬性</a> | <a href="#" onClick="showtajaxfun('goodsdetail');">詳細資料</a> | <!--a href="#" onClick="showtajaxfun('storage');">詳細庫存</a> |--> <a href="#" onClick="showtajaxfun('morepic');">多圖上傳</a> | <a href="#" onClick="showtajaxfun('goodslink');">相關商品</a> <?php if($ifxygoods == "1"){?>| <a href="#" onClick="showtajaxfun('xygoods');">超值任選商品</a><? }?> <?php if($ifpack == "1"){?>| <a href="#" onClick="showtajaxfun('packgoods');">組合商品</a><? }?> | <?php if($right_array[3]==1){?><a href="#" onClick="showtajaxfun('changegoods');">加購商品</a><? }}?></td>
          </tr>
        </table>
                  ...
                  width="100%" bgColor=#f7f7f7 border=0 id="showtable_base">
                          <TBODY>
                            ...
                            <TR>
                              ...
                              <TD><?php echo $FUNCTIONS->Input_Box('text','sale_name',$sale_name,"  id='sale_name'   maxLength=50 size=40 ")?>&nbsp;&nbsp;
                                  顏色：
                              <?php echo $FUNCTIONS->Input_Box('text','salename_color',$salename_color,"    maxLength=10 size=10  ")?>&nbsp;&nbsp;<INPUT   onclick='select_color(1);' type=button value=<?php echo $Basic_Command['Please_Select'];?> name=button></TD>
                            </TR>
                            <TR <?php if ($_SESSION['LOGINADMIN_TYPE']==1 && $_SESSION['sa_type']==0){ echo "style='display:none;'"; }?>>
                              ...
                              <TD colspan="2"><?php echo $FUNCTIONS->Input_Box('radio','ifpub',$Ifpub,$Add=array($Basic_Command['Yes'],$Basic_Command['No']))?></TD>
                              </TR>
                            <TR <?php if ($_SESSION['LOGINADMIN_TYPE']==1 && $_SESSION['sa_type']==0){ echo "style='display:none;'"; }?>>
					...
					?>
						...
						?>
                            ...
                            <TR>
                              ...
                              <TD align=left id="showattribute"></TD>
                              </TR>
                            <TR>
					...
					?>
					  ...
					  <?php } ?>
                            ...
                            <TR>
                              ...
                              <TD colSpan=2><?php echo $FUNCTIONS->Input_Box('text','subjectcontent',$subjectcontent,"  id='subjectcontent'   maxLength=255 size=75 ")?>
					...
					?>
                            <TR>
                              ...
                              <TD colSpan=2><?php echo $FUNCTIONS->Input_Box('text','bn',$Bn,"  id='bn'    maxLength=30 size=20 ")?>
					...
					?>
                            ...
                            <TR>
                              ...
                              <TD colSpan=2><?php echo $FUNCTIONS->Input_Box('text','guojima',$guojima,"  id='guojima'   maxLength=50 size=20 ")?></TD>
                              </TR>
                            <TR>
                              <TD noWrap align=right width="17%">型號：</TD>
                              <TD colSpan=2><?php echo $FUNCTIONS->Input_Box('text','xinghao',$xinghao,"  id='xinghao'   maxLength=50 size=20 ")?></TD>
                              </TR>
                            <TR>
                              <TD noWrap align=right width="17%">重量：</TD>
                              <TD colSpan=2><?php echo $FUNCTIONS->Input_Box('text','weight',$weight,"  id='weight'   maxLength=50 size=20 ")?><span class="p9orange"> 單位KG </span>註：1公斤(Kg)＝1000公克 ( g )  舉例50克 請填寫【 0.05 】 即可。 <a href="#" class="easyui-tooltip" title="適用於海外運費計算"><img src="images/tip.png" width="16" height="16" border="0"></a></TD>
                              </TR>
                            <TR>
                              <TD noWrap align=right>產地：</TD>
                              <TD colSpan=2><?php echo $FUNCTIONS->Input_Box('text','chandi',$chandi,"  id='chandi'   maxLength=255 size=20 ")?> </TD>
                              </TR>
                            <TR>
                              <TD noWrap align=right>ERP：</TD>
                              <TD colSpan=2><?php echo $FUNCTIONS->Input_Box('text','ERP',$ERP,"  id='ERP'   maxLength=255 size=20 ")?></TD>
                              </TR>
                            <TR>
                              <TD noWrap align=right width="17%">合作項目代號：</TD>
                              <TD colSpan=2><?php echo $FUNCTIONS->Input_Box('text','oeid',$oeid,"  id='bn'    maxLength=30 size=20 ")?> <a href="#" class="easyui-tooltip" title="通路王合作代號"><img src="images/tip.png" width="16" height="16" border="0"></a>					  </TD>
                              </TR>
                            
                            
                            <TR>
                              <TD noWrap align=right width="17%"><span class="p9orange">* <label for="price"><?php echo $Admin_Product[ProductSPrice];//市場價格?>：</label></span></TD>
                              <TD colSpan=2><?php echo $FUNCTIONS->Input_Box('text','price',$Price,"  id='price'   maxLength=\"20\" size=\"20\" ")?>
                              <a href="#" class="easyui-tooltip" title="<?php echo $Admin_Product[WhatisPrice]?>"><img src="images/tip.png" width="16" height="16" border="0"></a></TD></TR>
                            <TR>
                              <TD noWrap align=right width="17%"><span class="p9orange">* <label for="price"><?php echo $Admin_Product[ProductNetPrice];//網購價?>：</label></span></TD>
					  ...
					  ?></TD>
                            ...
                            <TR>
                              <TD noWrap align=right width="17%">毛利：</TD>
                              <TD colSpan=2 id="pmoney"> <?php echo $Pricedesc-$cost;?></TD>
                              </TR>
					...
					?></TD>
                            ...
                            <TR id=alarmshow <?php echo $DISPLAYalarm;?>>
                              ...
                              <TD colSpan=2><?php echo $FUNCTIONS->Input_Box('text','alarmnum',$Alarmnum,"      maxLength=20 size=20 ")?></TD>
                              </TR>
                            
                            <TR>
                              <TD noWrap align=right width="17%"><?php echo $Admin_Product[StorageNum];//库存数量：?>：</TD>
                              <TD colspan="2"><div class="link_box" style="width:100px;text-align:center"><a href="javascript:void(0);" onclick="showWin('url','admin_goods_ajax_changestorage.php?gid=<?php echo $Gid?>','',750,450);"><span class="link_box" style="width:100px">
                                <?php 
					  if ($_GET['Action'] == "Modi"){
						  echo $Storage;
					 ?>
					  ...
					  ?>	*<span id="yui_3_2_0_1_13115562779589743" lang="ZH-CN" xml:lang="ZH-CN">注意：若是任何人都可以瀏覽的商品請勿勾選。</span></TD>
                            ...
                            <!--TR>
                              ...
                              <TD colSpan=2><!?php echo $FUNCTIONS->Input_Box('text','video_url',$Video_url,"      maxLength=200 size=120 ")?>
                                <br />*請輸入商品影音資料URL位址，如 http://tw.g-utv.com/movie/utv.flv </TD>
                              </TR-->
                            <TR>
                              ...
                              <TD colSpan=2><?php echo $FUNCTIONS->Input_Box('textarea','intro',$Intro," cols=100 rows=4  ")?></TD>
                              </TR>
                            <TR  id=alarmshowcontent>
                              <TD width="17%" align=right noWrap valign="top">KeyWords：</TD>
                              <TD colSpan=2><?php echo $FUNCTIONS->Input_Box('textarea','keywords',$Keywords," cols=100 rows=4  ")?></TD>
                              </TR>
                            <TR>
                              <TD align=right valign="top" noWrap><?php echo $Admin_Product[AlarmContent];//使用規則：?>：</TD>
                              <TD colSpan=2><?php
					  ...
					  $CKEditor->returnOutput = true;
						...
						echo $code = $CKEditor->editor("alarmcontent", $AlarmContent);
                            ...
                            <TR>
                              <TD width="17%" align=right valign="top" noWrap>成分規格：</TD>
                              <TD colSpan=2><?php
					  ...
					  $CKEditor->returnOutput = true;
						...
						echo $code = $CKEditor->editor("cap_des", $cap_des);
                            ...
                            <TR>
                              <TD width="17%" align=right valign="top" noWrap><?php echo $Admin_Product[Detail_intro];//详细描述?>：</TD>
                  ...
                  width="100%" bgColor=#f7f7f7 border=0  id="showtable_cuxiao" style="display:none">
                          <TBODY>
                            ...
                            <TR>
                              ...
                              <TD colSpan=2><?php echo $FUNCTIONS->Input_Box('text','salecost',$salecost,"  id='salecost'   maxLength=\"10\" size=\"10\" readonly ")?>
			...
			?>      
                  ...
                  width="100%" bgColor=#f7f7f7 border=0  id="showtable_peisong" style="display:none">
                          <TBODY>
                            ...
                            <TR>
                              <TD align=right noWrap width="33%">配送方式：</TD>
                              <TD colSpan=2 width="67%"><?php echo $FUNCTIONS->Input_Box('radio','trans_type',$trans_type,$Add=array("特殊配送方式","一般配送方式"),$Event = array("viewtr(1,'transspecialshow');viewtr(0,'transabroadshow');viewtr(0,'yunsongshow');viewtr(0,'transaddshow');viewtr(0,'transmiddleshow');","viewtr(0,'transspecialshow');viewtr(1,'transabroadshow');viewtr(1,'yunsongshow');if (document.all.transtype[0].checked==true){viewtr(1,'transaddshow');viewtr(1,'transmiddleshow');}else{viewtr(0,'transaddshow');viewtr(0,'transmiddleshow');}"))?></TD>
                              </TR>
                            <TR id="transspecialshow" style="display:none">
                              <TD align=right noWrap>特殊配送方式：</TD>
                              <TD colSpan=2>
                                <?php 
					  $Sql_trans      = "select * from `{$INFO[DBPrefix]}transportation_special` order by trid ";
					  $Query_trans    = $DB->query($Sql_trans);
					  $Num_trans      = $DB->num_rows($Query_trans);
					  while ($Rs_trans=$DB->fetch_array($Query_trans)) {
					  ?>
                                <input type="radio" value="<?php echo $Rs_trans['trid'];?>" <?php if($trans_special == $Rs_trans['trid']) echo "checked";?> name="trans_special"  /><?php echo $Rs_trans['name'];?>
                                <?php
					  }
					  ?><br />
                                配送費用：<?php echo $FUNCTIONS->Input_Box('text','trans_special_money',$trans_special_money,"      maxLength=10 size=10 ")?>
                                </TD>
                              </TR>
                            <TR id="transabroadshow">
                              <TD align=right noWrap>是否支持海外配送：</TD>
                              <TD colSpan=2 noWrap width="67%"><?php echo $FUNCTIONS->Input_Box('radio','iftransabroad',$iftransabroad,$Add=array("允許","不允許"))?>（特殊費送方式不支持海外配送）</TD>
                              </TR>
