	...
	$(document).ready(
...

		{
			...
			$('#redactor').redactor({
				...
				autosave: 'admin_comment_save.php?act=autosave&Comment_id=<?php echo $_GET['comment_id'];?>',
...
<SCRIPT language=javascript>
	...
	function checkform(){
		...
		document.form1.action="admin_comment_save.php";
                              ...
                              <TABLE>
                                ...
                                <TBODY>
                                  ...
                                  <TR>
                                    ...
                                    <TD vAlign=bottom noWrap class="link_buttom"><a href="admin_comment_list.php"><IMG  src="images/<?php echo $INFO[IS]?>/fb-cancel.gif"   border=0>&nbsp;<?php echo $Basic_Command['Cancel'];//取消?></a></TD>
                              ...
                              <TABLE width="91%" height="18"  border=0 align="left" cellPadding=0 cellSpacing=0>
                                ...
                                <TBODY>
                                  ...
                                  <TR>
                                    ...
                                    <textarea name="FCKeditor1" id="redactor" cols="30" rows="10"  style="width:800px !important;"><?php echo $CoAnswer;?></textarea>
                                    </div>
