...
$s = $Where." and  gid!=".$Gid." ";
$Sql      = "select * from `{$INFO[DBPrefix]}goods`  where ifxy=1 ".$s." order by goodorder ";
...
<div style="height:400px;overflow:auto">
      ...
      <TABLE class=p12black cellSpacing=0 cellPadding=0 width="100%"   align=center border=0>
        ...
        <FORM name=optForm method=get action="admin_goods_ajax_xygoodssearch.php" id="linkgoodsform">        
        ...
        <TR>
          <TD align=center colSpan=2 height=31>
            <TABLE width="95%" border=0 align="center" cellPadding=0 cellSpacing=0 class=p12black>
              <TBODY>
              <TR>
                <TD width="305"   height=31 align=center nowrap class="p9black"><?php echo $Admin_Product[PleaseInputPrductName];//請輸入商品名稱?>&nbsp;
                 <INPUT  class='box1'  onmouseover="this.className='box2'" onMouseOut="this.className='box1'"   name='skey'>
				</TD>
                <TD width="73"  height=31 align="left" vAlign=center class=p9black>
		        &nbsp;&nbsp;&nbsp; <a href="#"><img src="images/<?php echo $INFO[IS]?>/t_go.gif" border=0 id="linksearch"></a>
                </TD>
        	    <TD width="650" align="right" vAlign=center class=p9black>
	...
	<div id="goodslinklist">
                  ...
                  <TABLE   width="95%" border=0 align="center" cellPadding=0 cellSpacing=0>
                    ...
                    <FORM name=adminForm action="admin_goods_ajax_xygoodssave.php" method=post id="selectlinkgoodsform">
                    ...
                    <TR class=row0>
					  ...
					  <TD align=left  height=20><IMG onMouseOver="MM_showHideLayers('imgLayer<?php echo $i?>','','show')" onMouseOut="MM_showHideLayers('imgLayer<?php echo $i?>','','hide')" height=18 src="images/<?php echo $INFO[IS]?>/icon-viewpic.gif" width=18>
                        <DIV class=shadow id=imgLayer<?php echo $i?> style="Z-INDEX: 3; VISIBILITY: hidden; WIDTH: 135px; POSITION: absolute; HEIGHT: 135spx"   border="1"><IMG src="../<?php echo $INFO['good_pic_path']?>/<?php echo $Rs['smallimg']?>" ></DIV>
					  </TD>
