...
if ($_GET['tagid']!="" && $_GET['Action']=='Modi'){
	$tagid = intval($_GET['tagid']);
	$Action_value = "Update";
	$Action_say  = "修改TAG"; //修改商品類別
	$Sql = "select * from `{$INFO[DBPrefix]}tag` where tagid=".intval($tagid)." limit 0,1";
	$Query = $DB->query($Sql);
...
<title>TAG管理--&gt;<?php echo $Action_say;?></title>
</HEAD>
...
<SCRIPT language=javascript>
	...
	function changecat(bid){
		...
		//form1.submit();
		location.href="admin_tag_save.php?Action=Insert&tagid="+bid;
	}
</SCRIPT>

<div id="contain_out">
<?php  include_once "Order_state.php";?>
  <FORM name=form1 action='admin_tag_save.php' method=post>
              ...
              <TABLE width="90%" border=0 cellPadding=0 cellSpacing=0>
                <TBODY>
                  <TR>
                    ...
                    <TD class=p12black noWrap><SPAN  class=p9orange>TAG管理--&gt;<?php echo $Action_say;?></SPAN></TD>
                </TR></TBODY></TABLE></TD>
                      ...
                      <TBODY>
                        <TR>
                          <TD align=middle width=79><!--BUTTON_BEGIN-->
                            ...
                            <a href="admin_tag_list.php"><IMG  src="images/<?php echo $INFO[IS]?>/fb-cancel.gif" border=0>&nbsp;<?php echo $Basic_Command['Cancel'];//取消?></a></TD></TR></TBODY></TABLE><!--BUTTON_END--></TD></TR></TBODY></TABLE></TD>
                  <TD align=middle>
                    <TABLE height=33 cellSpacing=0 cellPadding=0 width=79 border=0>
                      <TBODY>
                        <TR>
...
<TABLE class=allborder cellSpacing=0 cellPadding=2   width="100%" align=center bgColor=#f7f7f7 border=0>
                        <TBODY>
                          ...
                          <TR>
                            <TD noWrap align=right width="18%"> TAG名稱：</TD>
                            <TD noWrap align=left>
                              <?php echo $FUNCTIONS->Input_Box('text','tagname',$tagname,"      maxLength=50 size=40 ")?>				  </TD>
                            </TR>
