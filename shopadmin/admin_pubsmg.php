...
unset ($Num);
unset ($Result);
$Query  = $DB->query(" select mgroup_name,mgroup_id from `{$INFO[DBPrefix]}mail_group`   where mgroup_id>1  order by mgroup_id  asc  ");
$Num    = $DB->num_rows($Query);
?>
...
<div id="contain_out">
  <FORM name='form1' action='admin_pubsmg_new.php' method='post' >
              ...
              <TABLE width="90%" border=0 cellPadding=0 cellSpacing=0>
                <TBODY>
                  <TR>
                    ...
                    <TD class=p12black noWrap><SPAN  class=p9orange><?php echo $JsMenu[Functions];//功能?>--&gt;<?php echo $JsMenu[Shop_Pager];//网店会刊?>--&gt;選擇簡訊接收組
                      </SPAN></TD>
                  </TR></TBODY></TABLE></TD>
                ...
                <TR>
                  ...
                  <TD align=middle>
                    <TABLE height=33 cellSpacing=0 cellPadding=0 width=79 border=0>
                      <TBODY>
                        <TR>
                          <TD align=middle width=79><!--BUTTON_BEGIN-->
                            <TABLE>
                              <TBODY>
                                <TR>
                                  <TD vAlign=bottom noWrap class="link_buttom"><a href="javascript:checkform(<?php echo $Num?>);"><IMG src="images/<?php echo $INFO[IS]?>/fb-save.gif" border=0 >&nbsp;發送簡訊</a></TD></TR></TBODY></TABLE><!--BUTTON_END-->
                        ...
                        <TBODY>
                          ...
                          <TR>
                            <TD align=right valign="top" noWrap> 會員組：</TD>
					...
					?>  
                          ...
                          <TR>
                            <TD align=right valign="top" noWrap>簡訊內容：</TD>
