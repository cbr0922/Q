...
if ($_GET['k_tem_id']!="" && $_GET['Action']=='Modi'){

	$k_tem_id = intval($_GET['k_tem_id']);

	$Action_value = "Update";

	$Action_say  = $KeFu_Pack['Back_Nav_title'].$KeFu_Pack['Back_ModiHuiFu']; //修改回覆樣版

	$Query = $DB->query("select * from `{$INFO[DBPrefix]}kefu_tem` where k_tem_id=".intval($k_tem_id)." limit 0,1");
	...
	if ($Num>0){
		...
		$k_tem_name            =  $Result['k_tem_name'];

		$status                 =  $Result['status'];

		$checked                =  $Result['checked'];

		$k_tem_con              =  $Result['k_tem_con'];
	...
	$Action_say   = $KeFu_Pack['Back_Nav_title'].$KeFu_Pack['Back_AddHuiFu']; //添加樣版名稱
...
<SCRIPT language=javascript>
	...
	function checkform(){
		...
		if (chkblank(form1.k_tem_name.value)){

			form1.k_tem_name.focus();

			alert('<?php echo $KeFu_Pack['Js_input_mobanname'];?>');  //请输入回覆樣版名稱			
...
<FORM name=form1 action='admin_kefu_tem_save.php' method=post >

  <input type="hidden" name="Action" value="<?php echo $Action_value?>">

  <input type="hidden" name="k_tem_id" value="<?php echo $k_tem_id?>">
                      ...
                      <TBODY>
                        ...
                        <TR>
                          ...
                          <TD align=middle width=79><!--BUTTON_BEGIN-->
                            ...
                            <a href=<?php echo (isset($_GET['type'])||isset($_POST['type']))?'admin_kefu_tem_list.php?type='.$type.'&offset='.$offset:"admin_kefu_tem_list.php"?>><IMG  src="images/<?php echo $INFO[IS]?>/fb-cancel.gif" border=0>&nbsp;<?php echo $Basic_Command['Cancel'];//取消?></a></TD></TR></TBODY></TABLE><!--BUTTON_END--></TD></TR></TBODY></TABLE></TD>
                      ...
                      <TBODY>
                        ...
                        <TBODY>
                          ...
                          <TR>
                            ...
                            <TD noWrap align=right width="18%"><?php echo $KeFu_Pack['Back_HuiFuName'];//回覆樣版?>：</TD>

                            <TD colspan="2" align=left noWrap><?php echo $FUNCTIONS->Input_Box('text','k_tem_name',$k_tem_name,"      maxLength=50 size=50 ")?></TD>
                          ...
                          <TR>
                            ...
                            <TD align=right ><?php echo $KeFu_Pack['Back_HFContent'];//樣版的內容?>：</TD>

                            <TD colspan="2" width="82%"><?php echo $FUNCTIONS->Input_Box('textarea','k_tem_con',$k_tem_con," cols=80 rows=6")?></TD>
