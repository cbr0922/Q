					...
					?>
						...
						?>
                            ...
                            <TR>
                              ...
                              <TD colSpan=3><?php echo $FUNCTIONS->select_type("select brandname,brand_id from `{$INFO[DBPrefix]}brand` order by orderby asc,brand_id asc  ","brand_id","brand_id","brandname",intval($Brand_id)," onChange='changeBrandClass(this.value);'");  ?><?php //echo  // $FUNCTIONS->Input_Box('text','brand',$Brand,"      maxLength=40 size=40 ") ?>
