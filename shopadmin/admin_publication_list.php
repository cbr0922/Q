...
$Sql      = "select * from `{$INFO[DBPrefix]}publication` ".$Where." order by publication_end_time desc ";
...
function toSend(id){
	...
	if (checkvalue!=false){
		document.adminForm.action = "admin_pubgroup.php?pub_id="+checkvalue;
...
function toEdit(id,catid){
	...
	if (checkvalue!=false){
		...
		document.adminForm.action = "admin_publication.php?Action=Modi&publication_id="+checkvalue;
		document.adminForm.act.value="edit";
		document.adminForm.submit();
	}
}
...
function toDel(){
	...
	if (checkvalue!=false){
		if (confirm('<?php echo $Basic_Command['Del_Select']?>')){
			document.adminForm.action = "admin_publication_save.php";
              ...
              <TABLE width="90%" border=0 cellPadding=0 cellSpacing=0>
                <TBODY>
                  <TR>
                    ...
                    <TD class=p12black noWrap><SPAN class=p9orange><?php echo $JsMenu[Functions];//功能?>--&gt;<?php echo $JsMenu[Shop_Pager];//网店会刊?>--&gt;<?php echo $JsMenu[Shop_Pager_List];//会刊列表?></SPAN>
                    </TD>
                </TR></TBODY></TABLE></TD>
                      ...
                      <TR>
                        <TD align=middle width=79><!--BUTTON_BEGIN-->
                          <table>
                            <TBODY>
                              <TR>
                                <TD vAlign=bottom noWrap class="link_buttom"><a href="javascript:toSend(0);"><IMG  src="images/<?php echo $INFO[IS]?>/fb-sendmail.gif" width="31" height="29"  border=0>&nbsp;<?php echo $Mail_Pack[SendEmail];//发送邮件?></a></TD>
                              </TR>
                            </TBODY>
                          </TABLE>
                          <!--BUTTON_END--></TD>
                        ...
                        <TR>
                          <TD align=middle width=79><!--BUTTON_BEGIN-->
                            <TABLE>
                              <TBODY>
                                <TR>
                            <TD vAlign=bottom noWrap class="link_buttom"><a href="admin_publication.php"><IMG  src="images/<?php echo $INFO[IS]?>/fb-new.gif"  border=0>&nbsp;<?php echo $Mail_Pack[AddEmailBaoName];//新增?></a></TD></TR></TBODY></TABLE><!--BUTTON_END--></TD></TR></TBODY></TABLE></TD>
                  <TD align=middle>
                    <TABLE height=33 cellSpacing=0 cellPadding=0 width=79 border=0>
                      <TBODY>
                        <TR>
                ...
                <TBODY>
                  <TR>
                    <TD height=31 align=left>
                      <INPUT  name='skey'  onfocus=this.select()  onclick="if(this.value=='<?php echo $Search_sky?>')this.value=''"  onmouseover=this.focus() value='<?php echo $Search_sky?>' size="30"> 
                      &nbsp;
                        ...
                        <FORM name=adminForm action="" method=post>
                          ...
                          <TBODY>
                            <TR align=middle>
                              ...
                              <TD width="212"  height=26 align="left" noWrap background=images/<?php echo $INFO[IS]?>/bartop.gif class=p9black style1> <?php echo $Mail_Pack[EmailBaoName];//電子報標題?></TD>
					...
					?>
                            <TR class=row0>
                              ...
                              <TD height=20 align="center" noWrap><?php echo  $Last_sendtime = $Rs['publication_end_time']!="" ? date("Y-m-d H: i a",$Rs['publication_end_time']) : "" ;?>
                                &nbsp;</TD>
                              <td align="center"><div class="link_box" style="width:60px"><a href="admin_falsemail_list.php?pid=<?php echo $Rs['publication_id']?>">查看</a></div></td>
                              </TR>
                            <?php
					$i++;
					}
