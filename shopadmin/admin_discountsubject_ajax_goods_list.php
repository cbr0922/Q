...
$Where    .= " and ifbonus!=1 and ifpack!=1 and ifchange!=1 and ifpresent!=1 and ifgoodspresent!=1 and freetran!=1 ";
...
<?php if ($Num>0){ ?>
			<table width="95%"    border=0 align="center" cellpadding=0 cellspacing=0 class=p9gray>
              <tbody>
                <tr>
                  <td valign=center align=middle background=images/<?php echo $INFO[IS]?>/03_content_backgr.png height=23><?php echo $Nav->pagenav(1,"admin_discountsubject_ajax_goods_list.php","goodslinklist")?> </td>
                </tr>
