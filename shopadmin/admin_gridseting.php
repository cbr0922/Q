...
function addBanenr(){
	$.ajax({
		  ...
		  data: "count=" + $("#bannercount").attr("value") + "&tag=<?php echo $_GET['tag'];?>",
		  type:'get',
		  dataType:"html",
      ...
      <TABLE class=p9black cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
          <TR>
            ...
            <TD align=right width="50%" height="50"><TABLE cellSpacing=0 cellPadding=0 border=0>
              <TBODY>
                <TR>
                  <!--TD align=middle>
                      ...
                      <TABLE class=allborder cellSpacing=0 cellPadding=5  width="100%" align=center bgColor=#f7f7f7 border=0>
                        <TBODY>
                          ...
                          <TR>
                            <TD height="47" colspan="3" align=left noWrap>
							  <select name="tag" id="tag" onchange="location.href='admin_gridseting.php?tag='+this.value;">
                              	...
                              	<?php
								  $brand_Sql      = "select * from `{$INFO[DBPrefix]}brand` order by orderby asc, brand_id desc ";
                          ...
                          <TR>
                            ...
                            $Sql = "select * from `{$INFO[DBPrefix]}index_banner` " . $where_Sql . " order by bannerorder asc,ib_id desc";
							$Query    = $DB->query($Sql);
                            ...
                            <a href="#" onclick="delBanner(<?php echo $Result['ib_id'];?>);">刪除</a> 
