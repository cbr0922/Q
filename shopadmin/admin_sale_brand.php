        ...
        <FORM name=form1 id=form1 method=get action="">   
          ...
          <TR>
           ...
           <TR>
             ...
             <TD height="0" colspan="2" align=left class=p9black>
				...
				<!--<input type="radio" name="type" />瀏覽數-->
			</TD>
          ...
          <TR>-->
            ...
            <TD height="30" colspan="2" align=left class=p9black>
            	...
            	<input type="button" value="匯出excel表" onclick="javascript:location.href='admin_sale_brand_excel.php?<?php echo $_SERVER['QUERY_STRING']?>'" <?php if(!$_SERVER['QUERY_STRING']){echo "disabled";} ?>/>
            </TD>
                  	...
                  	<table id="itemTable" class="tablesorter">
						<thead> 
							<tr>
							  ...
							  <th width="285" height="1" align="left" class="p9black">品牌名稱</th>
						...
						<tbody id="listBox">
							...
							<tr>
								...
								<td align="left" class="p9black"><?php echo $Results[$i]['brandname'];?></td>
