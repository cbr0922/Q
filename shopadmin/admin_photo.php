...
<div id="contain_out"><? include "Order_state.php";?>
  ...
  <FORM name=form1 action='admin_photo_save.php' method=post enctype="multipart/form-data">
                      ...
                      <TABLE class=allborder cellSpacing=0 cellPadding=3 width="100%" align=center bgColor=#f7f7f7 border=0>
                        ...
                        <TBODY>
                          ...
                          <TR>
                            ...
                            <TD colspan="2" align="left" valign="middle" noWrap><input name="nimg" type="file" id="nimg"  size="40" /></TD>
                          </TR>
                            <?php if ($_GET['Action']=='Modi' && $Nimg!="") {?>
                          <TR>
                              <TD align=right>&nbsp;</TD>
                              <TD><img src="../UploadFile/photo_img/<?php echo $id.'/'.$Nimg?>"><a href="admin_photo_save.php?Action=DelPic&id=<?php echo $id?>" onClick="return confirm('您是否確認刪除該圖片?')">刪除</a></TD>
                          </TR>
                          <?php } ?>
