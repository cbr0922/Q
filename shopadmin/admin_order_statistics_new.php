...
<?php
//时段统计图
$Sql = "select count(order_id) as counts,from_unixtime(createtime, '%H') as hours,ifmobile from `{$INFO[DBPrefix]}order_table` group by ifmobile,from_unixtime(createtime, '%H')";
$Query    = $DB->query($Sql);
$AryData = array();
