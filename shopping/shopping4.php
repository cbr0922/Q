	...
	*/
	if ($Order_serial){
		...
		foreach($items_array as $item){
			...
			$Sql_Ok = "insert into `{$INFO[DBPrefix]}order_detail` (gid,goodsname,unit,good_color,good_size,goodscount,market_price,price,order_id,point,provider_id,month,detail_id,detail_bn,detail_name,detail_des,xygoods,ifxygoods,ifchange,xygoods_color,xygoods_size,xygoods_des,oeid,memberorprice,memberprice,combipoint,bonuspoint,ifbonus,bn,iftogether,cost,salecontent,detail_pay_state,detail_order_state,ifpack,packgid) values('".$item['gid']."','".$item['goodsname'].$item['rebateinfo']."','".$item['unit']."','".$item['good_color']."','".$item['good_size']."','".$item['count']."','".intval($item['temp_price'])."','".$item['price']."','".$Insert_id."','".$item['point']."','".$item['provider_id']."','".intval($item['month'])."','".intval($item['detail_id'])."','".$item['detail_bn']."','".$item['detail_name']."','".$item['detail_des']."','" . $xygoods . "','" . intval($item['ifxygoods']) . "','" . intval($item['ifchange']) . "','" . $xygoods_color . "','" . $xygoods_size . "','" . $item['xygoods_des'] . "','" . $item['oeid'] . "','" . $item['memberorprice'] . "','" . $item['memberprice'] . "','" . $item['combipoint'] . "','" . $item['bonuspoint'] . "','" . $item['ifbonus'] . "','" . $item['bn'] . "','".$item['iftogether']."','" . $cost . "','" . $salecontent . "','" . intval($pay_state) . "','" . intval($order_state) . "','" . $item['ifpack'] . "','" . $item['packgid'] . "')";
