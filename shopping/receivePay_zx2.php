...
fclose($fh);
//$_GET['URLResEnc'] = "";
//print_r($_GET);exit;
if (isset($_POST)||isset($_GET)){
	...
	*/
	$return_array['order_serial'] = substr($return_array['order_serial'],0,13);
	if ($return_array['order_serial'] != ""){
		...
		if ($Num>0){
			...
			if (!($_GET['web_para']==25 || intval($_GET['cvstemp'])==26) || $deliveryid==69 || $paymentid==70){
...
if ($return_array['paystate'] ==2 &&  intval($_GET['web_para'])!=25){
?>
...
<?php
	...
	**/
	...
	if ($paymentid!=69 && $deliveryid==29 && $paytype==0 &&  intval($_GET['web_para'])==25 && $Cart_discount_totalPrices+$Cart_transmoney-$Cart_buypoint>0){
		$pay_array = array(
		...
		//if($Order_id>0){
			...
			if($pay_state!=1)
				$SMTP->MailForsmartshop($useremail.",".$receiver_email,$cmail,6,$Array);
